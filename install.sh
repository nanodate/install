...
wget http://cdn.npm.taobao.org/dist/node/latest/node-v9.9.0-linux-armv7l.tar.xz
tar -xvf node-v9.9.0-linux-armv7l.tar.xz
mkdir app
mv node-v9.9.0-linux-armv7l /root/app/node
...
rm node-v9.9.0-linux-armv7l.tar.xz zlib-1.2.11.tar.gz
